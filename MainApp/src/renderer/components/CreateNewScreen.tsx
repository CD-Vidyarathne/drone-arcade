...
const CreateNewScreen: React.FC = () => {
  ...
  const handleCheck = (
    ...
    setRepair({...repair,accessories:{ ...repair.accessories, [inputName]: e.target.checked }});
  ...
  return (
    <div>
      ...
      <button className='btn btn-wide btn-success rounded-[1rem] hover:scale-110' onClick={(e)=>createNew(e)}>Create New Job</button>
    </div>
  );
};
